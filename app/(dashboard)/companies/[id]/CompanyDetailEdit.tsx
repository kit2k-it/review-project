...
// Helper to safely access socialLinks with proper typing
function getSocialLinks(company: Company) {
  return company.socialLinks as { facebook?: string; tiktok?: string } | null | undefined;
}

export default function CompanyDetailEdit({ company, canUpdate }: Props) {
